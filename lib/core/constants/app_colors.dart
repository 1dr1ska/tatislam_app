...
/// App color palette for TatIslam
class AppColors {
  AppColors._();

  // Primary Colors
  static const Color primary = Colors.white;
  static const Color secondary = Color(0xFF3CB371); // Lighter Islamic Green
  ...
  // Status Colors
  static const Color success = Color(0xFF3CB371); // Lighter Islamic Green
  static const Color error = Color(0xFFE53935);
  static const Color warning = Color(0xFFFFC107);

  // Type Colors
  static const Color articleColor = Color(0xFF3CB371); // Lighter Islamic Green
  ...
  static const Color website = Color(0xFF3CB371); // Lighter Islamic Green
  static const Color email = Color(0xFF757575);

  // Bottom Navigation Colors
  static const Color navHome = Color(0xFF3CB371); // Lighter Islamic Green
