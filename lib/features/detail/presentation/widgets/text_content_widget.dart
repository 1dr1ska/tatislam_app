...
class _TextContentWidgetState extends ConsumerState<TextContentWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    // Выравнивание по ширине (justify) растягивает одиночные пробелы так, что
    // слова «размазываются» по строке — на узких экранах это выглядит плохо и
    // ухудшает читаемость. Рекомендуемый вариант для больших текстов на
    // мобильных — «рваный правый край» (start), как у газет/книг в интернете.
